...
Each entry under CAR_CATALOGUE contains:
  base_maintenance_nok   – estimated annual maintenance cost at baseline (NOK)
...
CAR_CATALOGUE: dict[str, dict[str, Any]] = {
    ...
    "Tesla Model Y": {
        "base_maintenance_nok": 6500,
        "residual_base": 0.69,
        "consumption": {"kwh": 18.0},
    },
    "Toyota Avensis": {
        "base_maintenance_nok": 9000,
        "residual_base": 0.55,
        "consumption": {"petrol_l": 6.8},
    },
    "Toyota RAV4 Hybrid": {
        "base_maintenance_nok": 8000,
        "residual_base": 0.78,
